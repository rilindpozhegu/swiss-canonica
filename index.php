...
<section class="owl_section_nd">
    ...
    <!-- Join Us Section -->
    <section class="container-fluid join_us_section">
        <div class="row">
            <div class="col-md-6 no_padding">
                <img src="img/image_more_info-01.png">
            </div>
            <div class="col-md-6 join_us_section_text">
                <h3>JOIN US</h3>
                <hr>
    ...
    <!-- News Letter Section smaller -->
    
    <section class="new_letter_section">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1 class=" wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">Sign up to our newsletter</h1>
                </div>
                <div class="col-md-6 input_section_home">
                    <input type="" name="" placeholder="Enter Your Email">
                    <button class="hvr-bounce-to-right wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">Sign up&nbsp;  <i class="fa fa-angle-right" aria-hidden="true"></i></button>
                </div>
            </div>
        </div>
    </section>
